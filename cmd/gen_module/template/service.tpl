...
func (s *{{.Name}}Service) FindList(query FindNewsListOption) (utils.ListResult[[]*model.News], error) {
...
func (s *{{.Name}}Service) Create(info model.News) (*model.News, error) {
...
func (s *{{.Name}}Service) Update(id uint, info model.News) (*model.News, error) {
...
func (s *{{.Name}}Service) UpdatePermissionCode(id uint, codes dbtypes.StringArray) (*model.News, error) {
	current, err := dao.AdminRole.FindByID(id)
	if err != nil {
		return current, errs.CreateServerError("角色不存在", err, nil)
	}
