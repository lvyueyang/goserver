...
func newAccount(db *gorm.DB, opts ...gen.DOOption) account {
	...
	_account.Type = field.NewUint(tableName, "type")
	...
	_account.WxOpenId = field.NewString(tableName, "wx_open_id")
	_account.WxUnionId = field.NewString(tableName, "wx_union_id")
	_account.UserID = field.NewUint(tableName, "user_id")
...
func (a *account) updateTableName(table string) *account {
	...
	a.WxOpenId = field.NewString(table, "wx_open_id")
	a.WxUnionId = field.NewString(table, "wx_union_id")
...
func (a *account) fillFieldMap() {
	...
	a.fieldMap["wx_open_id"] = a.WxOpenId
	a.fieldMap["wx_union_id"] = a.WxUnionId
